export default {
    ...
    options: {
      ...
      //   //0.5为 公式 l=n°πr÷180°
      //   that.data.ctx2.save();
      //   var num = (2 * Math.PI / 100 * c)+ Math.PI ;
      //   that.data.ctx2.arc(w, h, w - 8, 1 * Math.PI, num); //每个间隔绘制的弧度
      //   that.data.ctx2.setStrokeStyle("#5badfb");
      //   that.data.ctx2.setLineWidth("4");
      //   that.data.ctx2.setLineCap("butt");
      //   that.data.ctx2.stroke();
      //   that.data.ctx2.restore();

      //   that.data.ctx2.beginPath();
      //   that.data.ctx2.draw();
      //   that.data.ctx2.closePath();
